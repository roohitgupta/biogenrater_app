...
const BioForm = () => {
  return (
    <div className="w-3/4 h-96 m-3 border-solid border-4 border-sky-500">
      <h1 className="text-xl text-center font-bold underline">Bio Form</h1>

      <div className="flex justify-between align-bottom bg-gray-200 my-3 w-full h-30 border-solid border-2 border-red-300 p-3">
